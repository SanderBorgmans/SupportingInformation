...
def get_cv(ff):
    cv_ohb = CVDistanceProjection(ff.system, [np.array([141]),np.array([190])])
    ...
    cv_ivr = CVDistanceProjection(ff.system, [np.array([188]),np.array([92])])

    cv_ihb = CVDistanceProjection(ff.system, [np.array([140]),np.array([191])])
    ...
    cv_ovr = CVDistanceProjection(ff.system, [np.array([189]),np.array([91])])
