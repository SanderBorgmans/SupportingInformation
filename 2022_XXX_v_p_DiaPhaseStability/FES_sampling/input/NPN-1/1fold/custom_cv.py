...
def get_cv(ff):
    cv_ohb = CVDistanceProjection(ff.system, [np.array([141]),np.array([188])])
    cv_oht = CVDistanceProjection(ff.system, [np.array([42]),np.array([93])])

    cv_ivl = CVDistanceProjection(ff.system, [np.array([142]),np.array([44])])
    cv_ivr = CVDistanceProjection(ff.system, [np.array([190]),np.array([92])])

    cv_ihb = CVDistanceProjection(ff.system, [np.array([140]),np.array([189])])
    cv_iht = CVDistanceProjection(ff.system, [np.array([41]),np.array([90])])

    cv_ovl = CVDistanceProjection(ff.system, [np.array([139]),np.array([43])])
    cv_ovr = CVDistanceProjection(ff.system, [np.array([191]),np.array([91])])
