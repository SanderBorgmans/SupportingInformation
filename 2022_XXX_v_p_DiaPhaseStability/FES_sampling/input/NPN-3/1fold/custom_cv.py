...
def get_cv(ff):
    cv_ohb = CVDistanceProjection(ff.system, [np.array([181]),np.array([251])])
    ...
    cv_ivr = CVDistanceProjection(ff.system, [np.array([250]),np.array([110])])

    cv_ihb = CVDistanceProjection(ff.system, [np.array([180]),np.array([252])])
    ...
    cv_ovr = CVDistanceProjection(ff.system, [np.array([253]),np.array([111])])
