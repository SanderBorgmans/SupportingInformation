...
def setup_inp(CONFINEMENT_THR,OVERLAP_THR,KAPPA_GROWTH_FACTOR,MAX_GRID_REFINEMENT_IT,MAX_KAPPA=150):
    ...
    inp = NDFS_Input(mode,kappas,spacings,edges,plot=True,units=units,
                     ...
                     MAX_GRID_REFINEMENT_IT=MAX_GRID_REFINEMENT_IT,MAX_KAPPA=MAX_KAPPA)
