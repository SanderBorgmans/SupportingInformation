...
guest       =   lambda x,y : True



afilters = [('C4', C4), ('C_C4', C_C4), ('C_C4_BR', C_C4_BR), ('C_NI', C_NI), ('C_NI_BR_O', C_NI_BR_O),
            ('C_N', C_N), ('N_L', N_L), ('C_N_BR_O', C_N_BR_O), ('C_N_BR_I', C_N_BR_I), ('C_N_BR_L', C_N_BR_L), ('C_N_L', C_N_L),
            ('H_NI_BR_O', H_NI_BR_O), ('H_N_BR_O', H_N_BR_O), ('H_N_BR_I', H_N_BR_I), ('H_C4_BR', H_C4_BR), ('H_N', H_N), ('guest',guest),
            ]
