...
def get_cv(ff):
    cv_ohb = CVDistanceProjection(ff.system, [np.array([227]),np.array([370])])
    ...
    cv_ivr = CVDistanceProjection(ff.system, [np.array([368]),np.array([182])])

    cv_ihb = CVDistanceProjection(ff.system, [np.array([230]),np.array([371])])
    ...
    cv_ovr = CVDistanceProjection(ff.system, [np.array([369]),np.array([185])])
