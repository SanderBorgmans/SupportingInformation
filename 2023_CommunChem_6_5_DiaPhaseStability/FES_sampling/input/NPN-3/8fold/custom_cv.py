...
def get_cv(ff):
    cv_ohb = CVDistanceProjection(ff.system, [np.array([181]),np.array([253])])
    cv_oht = CVDistanceProjection(ff.system, [np.array([42]),np.array([112])])

    cv_ivl = CVDistanceProjection(ff.system, [np.array([183]),np.array([43])])
    cv_ivr = CVDistanceProjection(ff.system, [np.array([252]),np.array([110])])

    cv_ihb = CVDistanceProjection(ff.system, [np.array([180]),np.array([250])])
    cv_iht = CVDistanceProjection(ff.system, [np.array([41]),np.array([113])])
    
    cv_ovl = CVDistanceProjection(ff.system, [np.array([182]),np.array([40])])
    cv_ovr = CVDistanceProjection(ff.system, [np.array([251]),np.array([111])])
